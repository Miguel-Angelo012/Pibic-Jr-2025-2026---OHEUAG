...
prof1.setHorarios_Bloqueados(("SEG", "T", "CD")) #8

prof1.setHorarios_Bloqueados(("TER", "M", "AB"))
prof1.setHorarios_Bloqueados(("TER", "M", "CD"))
prof1.setHorarios_Bloqueados(("TER", "T", "AB"))
prof1.setHorarios_Bloqueados(("TER", "T", "CD")) # 16

prof1.setHorarios_Bloqueados(("SEX", "M", "AB"))
prof1.setHorarios_Bloqueados(("SEX", "M", "CD")) #20

# prof1.setHorarios_Bloqueados(("SEX", "T", "AB")) #22 #caso esteja bloqueado mais de 20 horas, não será criado a grade de horários, ao invés, será printado uma mensagem
